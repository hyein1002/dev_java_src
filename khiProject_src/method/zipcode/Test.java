...
public class Test {
	...
	static Test t2 = null;
	public static Test getInstance() {//미묘한 차이가 있기때문에.....
		if(t2==null){//메소드 안에서 인스턴스화를 하는 이유는 널인걸 확인하고 객체를 주입할수있다.
			t2 = new Test();
		}
		return t2;//메소드를 통해서 객체를 반환할수있다. 인스턴스화를 메소드 안에서 할수있다ㅣ.
	}
	String setName() {
		return "이순신";
	}
