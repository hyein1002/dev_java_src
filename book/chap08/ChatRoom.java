...
public class ChatRoom extends JFrame {
	//JTable 헤더에 들어갈 정보들의 이름을 1차배열로 선언하기
	String cols[] = {"톡방명", "총인원수","현재참여자"};
	//JTable에 들어갈 데이터 영역을 생성하기
	//데이터는 존재하지 않으므로 0을 주었고 컬럼의 수는 톡방명, 총인원수, 현재참여자명단
	//이렇게 3이므로 3을 주었음
	...
	ArrayList<ChatRoom> ch = new ArrayList<ChatRoom>();
	
	public ChatRoom() {
		//따라서 최종적으로 화면에 붙일 때 JTable이 아닌 JScrollPane을 붙음.
