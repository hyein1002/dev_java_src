...
public class SendMail {
	...
	try {
		//발신자 설정
		final String sendId = "hyene02";//네이버 계정 아이디
		final String sendPass = "rlagPDls";//데이버 계정 비번
		String sendEmaillAddress = "hyene02@naver.com";		
		...
		//수신자 설정
		String receiveEmailAddress = "hyene02@gmail.com";
		//제목 설정
		String subject = "안녕하세요. 이순신입니다.";
		//메일 내용 설정
		String content = "시험 5번문제 보내기 연습입니다.";		
		//일반 테스트 형태
		message.setFrom(new InternetAddress(sendEmaillAddress));
